...
export const icons = {
  ...
  Courses: (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><path d="m1 1h4l2.6 13.1c.3 1.1 1.4 1.9 2.5 1.9h8c1.6 0 2.8-1.5 2.5-3.1L21 6H7"/></svg>
  ),
  Favoris: (props) => (
  ...
  User: (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="10" r="3"/><path d="M7 21v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2"/></svg>
  ),
  Star: (props) => (
  ...
  ChefHat: (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3C9 3 6.8 5 7 7.5A2.5 2.5 0 0 0 9.5 10H14.5A2.5 2.5 0 0 0 17 7.5C17.2 5 15 3 12 3Z"/><path d="M6 10V19A2 2 0 0 0 8 21H16A2 2 0 0 0 18 19V10"/></svg>
  ),
};
